...
public class Valakas extends DefaultAI
{
	...
	final Skill s_destroy_body = getSkill(5860, 1), s_destroy_soul = getSkill(5861, 1), s_destroy_soul2 = getSkill(5863, 1);
	...
	protected boolean createNewTask()
	{
		...
		switch (_hpStage)
		{
			...
			case 5:
				...
				addDesiredSkill(d_skill, target, distance, s_meteor);
				addDesiredSkill(d_skill, target, distance, s_fear);
				addDesiredSkill(d_skill, target, distance, s_destroy_soul2);
				break;
		}
	...
	{
		List<Creature> hateList = getActor().getAggroList().getHateList();

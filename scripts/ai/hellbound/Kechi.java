...
{
	private static final Logger LOG = LoggerFactory.getLogger(Kechi.class);
	...
	private void spawnMobs()
	{
		...
		for (int[] run : guard_run)
			...
			{
				LOG.error("Error on Kechi Spawn Mobs", e);
			}
	}
	...
	{
		getActor().getReflection().startCollapseTimer(5*60*1000L);

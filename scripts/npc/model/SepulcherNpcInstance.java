...
public class SepulcherNpcInstance extends NpcInstance
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1089209651711013054L;
	...
	public void showChatWindow(Player player, int val, Object... arg)
	{
		...
		switch (getNpcId())
		{
			...
			case 31466:
			case 31467:
				if (player.isInParty() && !hasPartyAKey(player.getParty().getPartyLeader()))
				{
					Functions.addItem(player.getParty().getPartyLeader(), HALLS_KEY, 1, "SepulcherNpcInstance");
					doDie(player);
				}
				return;
		}

...
public class KoreanStyle extends Functions /*implements ScriptFile, OnDeathListener,
		OnTeleportListener, OnPlayerExitListener, OnCurrentHpDamageListener*/ {
	...
	public static void endBattle(boolean blueIsWinner)
	{
		...
		final ExCubeGameChangePoints initialPoints = new ExCubeGameChangePoints(360, (!blueIsWinner ? Config.EVENT_KOREAN_PLAYERS_IN_TEAM : 0), (!blueIsWinner ? 0 : Config.EVENT_KOREAN_PLAYERS_IN_TEAM));

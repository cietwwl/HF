...
//	{
//		/*if(_pScoreStatic.get(player.getObjectId()) == null)
//			return 0;
//		return _pScoreStatic.get(player.getObjectId());*/
//		return 0;
//	}
//	
...
//		if (_pScoreStatic.get(player.getObjectId()) != null)
//			score2 = _pScoreStatic.get(player.getObjectId());		
//		_pScoreStatic.put(player.getObjectId(), score2 + 1);
//		
//		String text = "";
//		
...
//		{
//			player1.sendPacket(new ExShowScreenMessage(text, 3000, ScreenMessageAlign.BOTTOM_RIGHT, true));
//		}
//		
//		for (Player player2 : getPlayers(players_list2)) 
//		{
//			player2.sendPacket(new ExShowScreenMessage(text, 3000, ScreenMessageAlign.BOTTOM_RIGHT, true));	
//		}
//		*/		
//	}
//	
...
//		//ExCubeGameExtendedChangePoints secretPoints = new ExCubeGameExtendedChangePoints(timeLeft, bluePoints, redPoints, isRed, player, getPlayerPoints(player));
//		
//		for (Player player1 : getPlayers(players_list1))
//		{
//			player1.sendPacket(changePoints);
//			//player1.sendPacket(secretPoints);		
//			player1.broadcastCharInfo();	
//		}
//		
//		for (Player player2 : getPlayers(players_list2)) 
//		{
//			player2.sendPacket(changePoints);	
//			//player2.sendPacket(secretPoints);	

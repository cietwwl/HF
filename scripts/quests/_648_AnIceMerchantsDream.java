...
public class _648_AnIceMerchantsDream extends Quest implements ScriptFile
{
	...
	public String onKill(NpcInstance npc, QuestState qs)
	{
		...
		if (cond > 0)
		{
			qs.rollAndGive(Silver_Ice_Crystal, (int)Config.RATE_QUESTS_DROP, npc.getNpcId() - 22050);
			if (cond == 2)
				qs.rollAndGive(Silver_Hemocyte, (int)Config.RATE_QUESTS_DROP, Silver_Hemocyte_Chance);
		}

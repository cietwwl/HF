...
public class RewardVote implements IVoicedCommandHandler, ScriptFile
{
	...
	private static final String[] COMMANDS_LIST = new String[] { "vote" };

	// Rewards
	private static final int[][] BLESSED_ENCHANTS_CATEGORY = { { 6673, 1 } };

	private static final int[] PERMANENT_CATEGORY = { 40000, // Vote Rune
			1 };

	private static final int[][] MISC_CATEGORY = { { 6673, 2 }, { 6673, 3 }, { 6673, 4 } };
	private static final double[][] RANDOM_CATEGORY = { { 6577,// 1 Blessed Enchant Weapon S
			1,
			0.05 }, { 6578,// 1 Blessed Enchant Armor S
			1,
			0.233 }, { 13071,// 1 Red Soul Crystal - Stage 16
			1,
			0.3 }, { 13072,// 1 Blue Soul Crystal - Stage 16
			1,
			0.3 }, { 13073,// 1 Green Soul Crystal - Stage 16
			1,
			0.3 }, { 10480,// 1 Red Soul Crystal - Stage 15
			1,
			0.566 }, { 10481,// 1 Blue Soul Crystal - Stage 15
			1,
			0.566 }, { 10482,// 1 Green Soul Crystal - Stage 15
			1,

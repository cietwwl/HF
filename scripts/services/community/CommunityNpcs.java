...
public class CommunityNpcs implements ScriptFile, ICommunityBoardHandler
{
	...
	public void onBypassCommand(Player player, String bypass)
	{
		...
		if("actionToAsk".equals(cmd))
		{
			...
			String message = null;
			if(id == 0)
				message = "Would you like to increase Warehouse Slots by 1 for " + Config.SERVICES_EXPAND_INVENTORY_PRICE + " Pound?";
			else if(id == 1)
				message = "Would you like to increase Clan Warehouse Slots by 1 for " + Config.SERVICES_EXPAND_CWH_PRICE + " Pound?";
	...
	private static final int[] PKS = { 1, 5, 10, 50, 100, 250, 500, 1000 };
	...
	private void decreasePKPage(Player player)
	{
		...
		replacements[replaceIndex] = "<button value=\"Back\" action=\"bypass _bbsfile:smallNpcs/exclusiveShop\" width=200 height=30 back=\"L2UI_CT1.OlympiadWnd_DF_Back_Down\" fore=\"L2UI_ct1.OlympiadWnd_DF_Back\">";
	...
	{
		return "<button value=\"" + pks + " PKs for " + (Config.SERVICES_WASH_PK_PRICE * pks) + " Pounds\" action=\"bypass _decreasePK_" + pks + "\" width=200 height=30 back=\"L2UI_CT1.OlympiadWnd_DF_HeroConfirm_Down\" fore=\"L2UI_ct1.OlympiadWnd_DF_HeroConfirm\">";
	}

...
public class CommunityEvents implements ScriptFile, ICommunityBoardHandler
{
	...
	private String getEventInfo(String html, Player player)
	{
		...
		if(event == null)
			...
			register = "<button value=\"Unregister from Event\" action=\"bypass _bbseventUnregister\" width=165 height=34 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\">";
		else
			register = "<button value=\"Register to Event\" action=\"bypass _bbseventRegister\" width=165 height=34 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\">";

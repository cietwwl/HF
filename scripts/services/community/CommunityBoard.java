...
public class CommunityBoard implements ScriptFile, ICommunityBoardHandler
{
	...
	public void onBypassCommand(Player player, String bypass)
	{
		...
		if("bbshome".equals(cmd))
		{
			...
			html = html.replace("<?online_time?>", String.valueOf(getOnlineTime(player)));
	...
	{
                long totalSec = System.currentTimeMillis()/1000 - player.getOnlineBeginTime();
		long hours = totalSec / 3600;

		if (hours>1)
			return (int)hours + " h. " + String.valueOf(((int)totalSec - (int)(hours*3600))/60) + " m.";
                else
                        return (int)totalSec/60 + " m.";
	}

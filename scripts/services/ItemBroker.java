...
public class ItemBroker extends Functions
{
	...
	public String getHtmlAppends(Integer val)
	{
		...
		switch(val)
		{
			case 0:
				...
				append.append("[npc_%objectId%_auctionItemsSale|<font color=\"FF9900\">The list of goods for sale</font>]<br1>");
	...
	public void listForItem(String[] var)
	{
		...
		StringBuilder out = new StringBuilder(200);
		if(search == null)
			listPageNum(out, type, itemType, returnPage, minEnchant, rare, "Â«Â«");
		else
			findPageNum(out, type, returnPage, search, "Â«Â«");
		out.append("&nbsp;&nbsp;");

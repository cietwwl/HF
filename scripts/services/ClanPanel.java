...
public class ClanPanel extends Functions
{
	public void editDescription()
	{
		...
		String html = HtmCache.getInstance().getNotNull("scripts/services/RecruitmentPanel/edit.htm", player);
		show(html, player);
	}
	...
	public void addDescription()
	{
		...
		String html = HtmCache.getInstance().getNotNull("scripts/services/RecruitmentPanel/add.htm", player);
		show(html, player);
	}
	...
	public void addRequest(String[] param)
	{
		...
		String html = HtmCache.getInstance().getNotNull("scripts/services/RecruitmentPanel/request.htm", player);
	...
	public void online(String[] param)
	{
		...
		if(clan != null)
		{
			String html = HtmCache.getInstance().getNotNull("scripts/services/RecruitmentPanel/clan_online.htm", player);
			String template = HtmCache.getInstance().getNotNull("scripts/services/RecruitmentPanel/clan_online_template.htm", player);
			String list = "";
			String data = "";
			int current = 1;
			int start = (page - 1) * 10;

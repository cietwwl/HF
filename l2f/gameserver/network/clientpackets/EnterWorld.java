...
public class EnterWorld extends L2GameClientPacket
{
	...
	protected void readImpl()
	{
        ...
        {
            try(FileWriter writer = new FileWriter("./log/hwid.log", true); BufferedWriter bufferWriter = new BufferedWriter(writer))
            {
               bufferWriter.write(player.getName() + ": "+ player.getHWID()+" "+Calendar.getInstance().getTime() + "\n");
            }

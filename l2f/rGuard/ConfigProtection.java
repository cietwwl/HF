...
import  l2f.rGuard.crypt.FirstKey;
...
{
  private static final Logger _log = LoggerFactory.getLogger(ConfigProtection.class);
  public static final String D_GUARD_FILE = "./config/rGuard.properties";
...
public static final void load()
  {
    File fp = new File("./config/rGuard.properties");
    ...
    if (ALLOW_GUARD_SYSTEM)
      try {
        ...
        _log.info("==========[ Loading rGuard configuration ]==========");
